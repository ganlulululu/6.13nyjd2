...
<body>
	...
	<div class="collapse navbar-collapse" id="navbar-ex1-collapse">
		<ul class="nav navbar-nav ">
			<li><a id="dropdown-toggle" href="http://localhost:8080/fkbookapp/index"><strong>基地首页</strong></a></li>
						...
						<div class="col-sm-7 col-md-8">
							<div class="col-md-12">
								...
								<li style="margin-top:50px">
									<a href="http://localhost:8080/fkbookapp/index">首页>></a>
									<c:set var="module1" value="${requestScope.module}"></c:set>
									<a href="#">${module1.whole_name}>></a><c:forEach
								...
								<div class="body2">
									<div class="col-sm-12 col-md-12">
										<div class="col-sm-10 col-md-10" style="float: left">
											...
											<c:forEach items="${requestScope.modulepagelist}" var="module">
												...
												<li id="list_li"><img src="../../images/index_dd.jpg"><a 
										...
										<div class="col-sm-2 col-md-2">
											...
											<c:forEach items="${requestScope.modulepagelist}" var="module">
												...
												<li id="list_li"><span>${module.up_date}</span></li>
											</c:forEach>
									...
									<div id="page">
										<c:forEach items="${requestScope.modulepagelist}" var="module"
											begin="0" end="0">
											<p class="text-center">
												<a href="1">首页</a>&emsp;&emsp;<a
													href="${requestScope.lastpage}">&lt&lt上一页</a>&emsp;&emsp;当前为第${requestScope.pages2}页&emsp;&emsp;<a
													href="${requestScope.nextpage}">下一页>></a>&emsp;&emsp;共${requestScope.finalpage}页<a
													href="${requestScope.finalpage}">&emsp;&emsp;尾页</a>
											</p>
										</c:forEach>
									</div>
									<hr id="contenthr">

         ...
         <div>
            ...
            <div class="collapse navbar-collapse" id="navbar-ex1-collapse" >
                <ul class="nav navbar-nav " >
                    <li ><a href="http://localhost:8080/fkbookapp/index" id="dropdown-toggle">基地首页</a></li>
					...
					${name}<span class="caret"></span>
						...
						<ul class="dropdown-menu" >
                   				...
                   				<c:if test="${name=='学术队伍'}"> 
                      				...
                      				<li class="dropdown-brand"><a href="http://localhost:8080/fkbookapp/thirdPage/jdgk">${navber.module_name}</a></li>              					
                   					</c:forEach>  
                   				</c:if>
                   				<c:if test="${name=='科学研究'}"> 
...
<div class="container"  id="topcontainer">
 ...
 <div class="body">
    ...
    <div class="container"  id="maincontainer">
    	<div class="container col-sm-12 col-md-12" style="background-color:#ffffff">
    	  <div class="container">
             <div class="row" >
             <!-- <br> -->
          	 </div>
          	   <nav class=" navbar navbar-right" id="dqwz" role="navigation">
					            <ol class="breadcrumb" >
					                  ...
					                  <li style="color:#929292">${module1.longtitle}</li>
					             </ol>
				 </nav>
    	 </div>
		 <div>
            <div class="row">             
                    	<hr id="contenthr">
							...
							<h4> <center>2013年03月21日</center></h4><br>
							<div class="indexbody">
                          	 <p>${module1.content}</p>
							 </div>
